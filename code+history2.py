...
def show_history():
    ...
    # Declare history_listbox outside the if block
    history_listbox = None
    ...
    if history_window is None:
        ...
        # Create listbox elements (optional)
        ...
        history_listbox.delete(0, tk.END)  # Clear existing entries

    # Populate the listbox with calculation data
    for data in calculation_data:
        history_listbox.insert(tk.END, f"{data['nominal_diameter']} in, {data['pipe_length']} m")  # Modify format as needed
