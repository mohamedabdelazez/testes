...
def update_history():
    ...
    # Iterate through the calculation data and insert into the text widget
    for data in calculation_data:
        history_text.insert(tk.END, f"{data}\n")
...
def open_history_window():
    ...
    global history_text
    history_text = tk.Text(history_window, width=50, height=20)
    history_text.pack(padx=10, pady=10)

    # Button to update history
    update_button = ttk.Button(history_window, text="Update History", command=update_history)
    update_button.pack(pady=10)



history_button = ttk.Button(root, text="Show History", command=open_history_window)
