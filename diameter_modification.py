...
def calculate_diameter():
    ...
    if manual_diameter_var.get():
        selected_diameter = float(diameter_var.get())
    else:
    ...
    inner_diameter = pipe_material_inner_diameter_inches[material_var.get()][pipe_data["pipe_diameter_inches"].index(selected_diameter)]
    external_diameter = pipe_material_outer_diameter_inches[material_var.get()][pipe_data["pipe_diameter_inches"].index(selected_diameter)]
