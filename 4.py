...
def calculate_diameter():
    ...
    for min_flow, max_flow in pipe_data["flow_range_gpm_at_" + selected_hours]:
        if min_flow <= flow_rate <= max_flow:
            ...
            internal_diameter = pipe_material_inner_diameter_inches[material_var.get()][pipe_data["pipe_diameter_inches"].index(pipe_diameter)]
            ...
            internal_label.config(text=f"Internal Diameter: {internal_diameter} inches")
